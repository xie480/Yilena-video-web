...
import { getAnswerMeMsg,getUserFollowingUsers,getChatHistory,sendMessage,setMessageRead,deleteMessage } from '../../api/chat';
...
const getMsg = async () => {
  const result = await getAnswerMeMsg(currentUserId.value);
  if(result.code === 1){
