...
import { getOtherMsg,getAnswerMeMsg,getUserFollowingUsers,getChatHistory,sendMessage,setMessageRead,deleteMessage } from '../../api/chat';
...
const getMsg = async () => {
  const result = await getOtherMsg(currentUserId.value);
  if(result.code === 1){
